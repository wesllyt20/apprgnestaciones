<template>
  <v-app>
    ...
    <div class="barra-superior">
      ...
      <h1 class="titulo">Red Geofísica Nacional (REDGEN)</h1>
    ...
    <div id="contenedor" style="">
      <iframe
        ...
        src="https://ide.igp.gob.pe/geovisor/red-geofisica/"
...
export default {
  ...
  methods: {
    ...
    btnDash() {
      window.open(
        "https://ide.igp.gob.pe/portal/apps/dashboards/0b21d1b1227a4e8eb7bf8f7cc3cf6de8",
        "_blank"
      );
    },
    btnFuncion() {
